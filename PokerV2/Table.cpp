...
void DrawTable::PlayersShowHashCards()
{
	Evaluator E;
	HashEvaluator H;
	vector<Player*>::iterator p_it = m_players.begin();
...
void StudTable::PlayersShowHashCards()
{
	//GET WINNER
	Evaluator E;
	HashEvaluator H;
...
void OmahaTable::PlayersShowHashCards()
{
	//GET WINNER
	HashEvaluator H;
	Evaluator E;
...
void TexasTable::PlayersShowHashCards()
{
	//GET WINNER
	HashEvaluator H;
	Evaluator E;
